# ASAP - Today Checked In - Arike

> Count of urgent ASAP - Today appointments that have checked in

## Purpose

This query provides a count of active ASAP - Today appointments that have checked in and are waiting to be seen. It's useful for monitoring patient flow, wait times for urgent care, and ensuring timely response to critical patient needs in the Arike program.
...
- Only includes bookings with status = 'checked_in'
