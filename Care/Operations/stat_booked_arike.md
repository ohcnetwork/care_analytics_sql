# STAT Booked in - Arike

> Count of urgent STAT appointments currently booked

## Purpose

This query provides a count of active STAT (urgent "Right Now") appointments that are currently booked. It's useful for monitoring urgent care demand and ensuring timely response to critical patient needs in the Arike program.
