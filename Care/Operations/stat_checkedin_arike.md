# STAT Checked In - Arike

> Count of urgent STAT appointments that have checked in

## Purpose

This query provides a count of active STAT (urgent "Right Now") appointments that have checked in and are waiting to be seen. It's useful for monitoring patient flow, wait times for urgent care, and ensuring timely response to critical patient needs in the Arike program.
